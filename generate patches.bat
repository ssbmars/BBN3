...
flips -c -b "rom/bn3blue.gba" "bbn3.gba" ".ignore/release/bbn3.bps"

echo      creating singleplayer patch

flips -c -b "rom/bn3blue.gba" "bbn3_pve.gba" ".ignore/release/singleplayer version/bbn3_pve.bps"

echo      creating randomizer patch

flips -c -b "rom/bn3blue.gba" "rom/output.gba" ".ignore/release/singleplayer version/bbn3_pve_randomize.bps"
...
flips -c -b "bbn3_pve.gba" "bbn3_pve_bn3plus.gba" ".ignore/release/singleplayer version/bn3plus patch/bbn3_pve_bn3plus.bps"
