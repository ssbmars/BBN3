...
//new table value PlantMan	(0x6B)
.dw 0x80000084	;a
.dw 0x40000084	;b

//new table value FlashMan	(0x6C)
.dw 0x80000005	;a
.dw 0x40000005	;b

//new table value breaking realtime wind hit  (0x6D)
.dw 0x80000050	;a
.dw 0x40000050	;b

//new table value Jealousy with chip delete (0x6E)
.dw 0x80000485
.dw 0x40000485

//new table value Jealousy WITHOUT chip delete (0x6F)
.dw 0x80000085
.dw 0x40000085
